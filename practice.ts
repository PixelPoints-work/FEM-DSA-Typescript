...
// doubly linked list from scratch. The concept is fairly simple the implementation is a bit confusing at this time
...
function twoCrystalBall(arr: boolean[]): number {
